        ...
        <div className="bg-[var(--background)] rounded-lg p-6 border border-[var(--secondary)]/10">
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-[var(--secondary-text)] font-livvic-medium">
                The Crown Hub<br />
                Main Street<br />
                Thornton, Fife<br />
                KY1 4AF
            ...
            <div>
              <h3 className="text-lg font-livvic-bold text-[var(--secondary)] mb-2">Email</h3>
              <a
                href="mailto:contact@solutionsdeveloped.co.uk"
                className="text-[var(--accent)] hover:underline font-livvic-bold"
              >
                contact@solutionsdeveloped.co.uk
              </a>
            </div>
            <div>
              <h3 className="text-lg font-livvic-bold text-[var(--secondary)] mb-2">Telephone</h3>
              <a
